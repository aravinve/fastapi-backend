...
from src.models.generator_models import UUIDGeneratorRequest, TextGeneratorRequest, SecretGeneratorRequest, ColorGeneratorRequest
from src.models.generator_models import QRCodeGeneratorRequest
